...
root_raincityscapes = 'C:/PyTorch_CV/'
train_raincityscapes_path = root_raincityscapes
#os.path.join(root_raincityscapes, 'train')
#train_raincityscapes_gt_path = os.path.join(root_raincityscapes, 'image')

test_raincityscapes_path = root_raincityscapes
